...
from sockly.widgets.SocklyTab import SocklyTab


class Sockly(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Sockly — the WebSocket client')

    def add_tab(self):
        uid = self.uid
        self.uid += 1
        page = SocklyTab(self, uid)
